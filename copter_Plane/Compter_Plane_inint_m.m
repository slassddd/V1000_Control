...
PathModeOut_sl.flightTaskMode=ENUM_FlightTaskMode.TakeOffMode;
PathModeOut_sl.flightControlMode=ENUM_FlightControlMode.RotorGoUpDownBySpeed;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    POSCONTROL_ACC_Z_D=0.1;    % vertical acceleration controller D gain default
    ...
    POSCONTROL_ACC_Z_FILT_HZ_inint=20;
