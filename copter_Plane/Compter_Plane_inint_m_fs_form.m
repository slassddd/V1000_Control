...
m_kg=5;
 ...
 POSCONTROL_VEL_Z_P                       =  0.8                         ;
 POSCONTROL_ACC_Z_P                       =  0.8                         ;
 POSCONTROL_ACC_Z_I_inint                 =  0                           ;
 POSCONTROL_ACC_Z_D                       =  0                           ;
 POSCONTROL_ACC_Z_IMAX                    =  600                         ;
 POSCONTROL_ACC_Z_FILT_HZ_inint           =  0.2                         ;
 POSCONTROL_THROTTLE_CUTOFF_FREQ          =  1                           ;
 gains_tau_pitch                          =  1                           ;
 gains_P_pitch                            =  0.9                          ;
 gains_D_pitch                            =  0.35                        ;
 gains_I_pitch                            =  0.02                        ;
 roll_ff_pitch_inint                      =  0.9                         ;
 ...
 POSCONTROL_VEL_XY_P                      =  1.5                         ;
 POSCONTROL_VEL_XY_I_inint                =  0                           ;
 POSCONTROL_VEL_XY_D                      =  0                           ;
 POSCONTROL_VEL_XY_IMAX                   =  1000                        ;
 POSCONTROL_VEL_XY_FILT_HZ                =  10                          ;
