...
%     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        algo_roll_target_pilot =double(typecast(uint8(temp),'int16')')/32768*5000;        
        temp=reshape([data(1:2:end,185:186)'],1,[]);
        algo_pitch_target_pilot=double(typecast(uint8(temp),'int16')')/32768*5000;
        temp=reshape([data(2:2:end,165:168)'],1,[]);
        algo_current_loc_0 =double(typecast(uint8(temp),'int32')');
        temp=reshape([data(2:2:end,169:172)'],1,[]);
        algo_current_loc_1 =double(typecast(uint8(temp),'int32')');
        temp=reshape([data(2:2:end,79:80)'],1,[]);
        algo_tail_tilt =double(typecast(uint8(temp),'int16')');       
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     end
    fclose(fid); 
save([filename,'V1000_sl_att_txt.dat'],'data_ck','-ascii','-append' )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data_10 = [];
