...
%     };
    ...
    'IN_SENSOR.um482.Lon'; 
    'IN_SENSOR.um482.Lat';
    'IN_SENSOR.um482.height'; 
    'IN_SENSOR.um482.velN';
    'IN_SENSOR.um482.velE';
    'IN_SENSOR.um482.velD';
    'IN_SENSOR.um482.delta_lon'; 
    'IN_SENSOR.um482.delta_lat'; 
    'IN_SENSOR.um482.delta_height';
    'IN_SENSOR.um482.pDop'; 
    'IN_SENSOR.um482.POSTYPE'; 
    'IN_SENSOR.um482.numSv';
};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data_6 = [];
for i=1:length(data_bms_txt)
        data_6(:,i)=eval(data_bms_txt{i,1}); 
        end
        head=[data_bms_txt{1}];
        for i=2:length(data_bms_txt)
         head=[head ,' ',data_bms_txt{i}];
        end 
        head=[head ,'\n'];
data_ck=data_6(:,1:i);
