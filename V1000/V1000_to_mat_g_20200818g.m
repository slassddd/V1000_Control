...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        algo_groundspeedCmd=double(typecast(uint8(temp),'int16')')/32768*500; 
        temp=reshape([data(index_163,231:232)'],1,[]);
        algo_rollCmd=double(typecast(uint8(temp),'int16')')/32768*500;           
        temp=reshape([data(index_164,229:230)'],1,[]);
        algo_turnRadiusCmd=double(typecast(uint8(temp),'int16')')/32768*500; 
        ...
        algo_dR_turn=double(typecast(uint8(temp),'int16')')/32768*500; 
        ...
        temp = reshape([data(mod(Count,16)==11,243:244)'],1,[]);
        algo_airspeedCmd=double(typecast(uint8(temp),'int16')')/32768*500.0000000000;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
data = [];
   for i=1:length(data_ck_txt)
       data(:,i)=eval(data_ck_txt{i,1}); 
   end
   head=[data_ck_txt{1}];
   for i=2:length(data_ck_txt)
...
%     end
    fclose(fid); 
save([PathName,'\\',FileName,'V1000.dat'],'data_ck','-ascii','-append' )

% --------------------------------------------------imu txt----------------
data_1 = [];
for i=1:length(data_imu_txt)
        data_1(:,i)=eval(data_imu_txt{i,1}); 
        end
        head=[data_imu_txt{1}];
        for i=2:length(data_imu_txt)
         head=[head ,' ',data_imu_txt{i}];
        end 
        head=[head ,'\n'];
data_ck=data_1(:,1:i);
fid=fopen([PathName,'\\',FileName,'V1000_IMU.dat'],'w');
fprintf(fid,head);
%     [count,num]=size(data_ck);
%     for i=1:count
%         for j=1:num
...
%     end
    fclose(fid); 
save([PathName,'\\',FileName,'V1000_IMU.dat'],'data_ck','-ascii','-append' )
   
% --------------------------------------------------ublox txt--------------
data_2 = [];
for i=1:length(data_ublox_txt)
        data_2(:,i)=eval(data_ublox_txt{i,1}); 
        end
        head=[data_ublox_txt{1}];
        for i=2:length(data_ublox_txt)
...
%     end
    fclose(fid); 
save([PathName,'\\',FileName,'V1000_UBLOX.dat'],'data_ck','-ascii','-append' )

% --------------------------------------------------mag txt----------------
data_3 = [];
for i=1:length(data_mag_txt)
        data_3(:,i)=eval(data_mag_txt{i,1}); 
        end
        head=[data_mag_txt{1}];
        for i=2:length(data_mag_txt)
         head=[head ,' ',data_mag_txt{i}];
        end 
        head=[head ,'\n'];
data_ck=data_3(:,1:i);
fid=fopen([PathName,'\\',FileName,'V1000_MAG.dat'],'w');
fprintf(fid,head);
%     [count,num]=size(data_ck);
%     for i=1:count
%         for j=1:num
...
%     end
    fclose(fid); 
save([PathName,'\\',FileName,'V1000_MAG.dat'],'data_ck','-ascii','-append' )
% --------------------------------------------------radar txt--------------
data_4 = [];
for i=1:length(data_radar_txt)
        data_4(:,i)=eval(data_radar_txt{i,1}); 
        end
        head=[data_radar_txt{1}];
        for i=2:length(data_radar_txt)
         head=[head ,' ',data_radar_txt{i}];
        end 
        head=[head ,'\n'];
data_ck=data_4(:,1:i);
fid=fopen([PathName,'\\',FileName,'V1000_RADAR.dat'],'w');
fprintf(fid,head);
%     [count,num]=size(data_ck);
%     for i=1:count
%         for j=1:num
...
%     end
    fclose(fid); 
save([PathName,'\\',FileName,'V1000_RADAR.dat'],'data_ck','-ascii','-append' )

% --------------------------------------------------baror txt--------------
data_5 = [];
for i=1:length(data_baro_txt)
        data_5(:,i)=eval(data_baro_txt{i,1}); 
        end
        head=[data_baro_txt{1}];
        for i=2:length(data_baro_txt)
         head=[head ,' ',data_baro_txt{i}];
        end 
        head=[head ,'\n'];
data_ck=data_5(:,1:i);
fid=fopen([PathName,'\\',FileName,'V1000_BARO.dat'],'w');
fprintf(fid,head);
%     [count,num]=size(data_ck);
%     for i=1:count
%         for j=1:num
...
%     end
    fclose(fid); 
save([PathName,'\\',FileName,'V1000_BARO.dat'],'data_ck','-ascii','-append' )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data_6 = [];
for i=1:length(data_bms_txt1)
        data_6(:,i)=eval(data_bms_txt1{i,1}); 
        end
        head=[data_bms_txt1{1}];
        for i=2:length(data_bms_txt1)
         head=[head ,' ',data_bms_txt1{i}];
        end 
        head=[head ,'\n'];
data_ck=data_6(:,1:i);
fid=fopen([PathName,'\\',FileName,'V1000_bms.dat'],'w');
fprintf(fid,head);
%     [count,num]=size(data_ck);
%     for i=1:count
%         for j=1:num
...
%     end
    fclose(fid); 
save([PathName,'\\',FileName,'V1000_bms.dat'],'data_ck','-ascii','-append' )
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data_6 = [];
for i=1:length(data_bms_txt2)
        data_6(:,i)=eval(data_bms_txt2{i,1}); 
        end
        head=[data_bms_txt2{1}];
        for i=2:length(data_bms_txt2)
         head=[head ,' ',data_bms_txt2{i}];
        end 
        head=[head ,'\n'];
data_ck=data_6(:,1:i);
fid=fopen([PathName,'\\',FileName,'V1000_bms2.dat'],'w');
fprintf(fid,head);
%     [count,num]=size(data_ck);
%     for i=1:count
%         for j=1:num
...
%     end
    fclose(fid); 
save([PathName,'\\',FileName,'V1000_bms2.dat'],'data_ck','-ascii','-append' )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data_7 = [];
for i=1:length(data_arspeed_txt)
        data_7(:,i)=eval(data_arspeed_txt{i,1}); 
        end
        head=[data_arspeed_txt{1}];
        for i=2:length(data_arspeed_txt)
         head=[head ,' ',data_arspeed_txt{i}];
        end 
        head=[head ,'\n'];
data_ck=data_7(:,1:i);
fid=fopen([PathName,'\\',FileName,'V1000_arspeed.dat'],'w');
fprintf(fid,head);
%     [count,num]=size(data_ck);
%     for i=1:count
%         for j=1:num
...
%     end
    fclose(fid); 
save([PathName,'\\',FileName,'V1000_arspeed.dat'],'data_ck','-ascii','-append' )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% data_8 = [];
% for i=1:length(data_mag_yaw_txt)
%         data_8(:,i)=eval(data_mag_yaw_txt{i,1}); 
%         end
%         head=[data_mag_yaw_txt{1}];
%         for i=2:length(data_mag_yaw_txt)
%          head=[head ,' ',data_mag_yaw_txt{i}];
%         end 
%         head=[head ,'\n'];
% data_ck=data_8(:,1:i);
% fid=fopen([PathName,'\\',FileName,'V1000_mag_yaw.dat'],'w');
% fprintf(fid,head);
% %     [count,num]=size(data_ck);
% %     for i=1:count
% %         for j=1:num
...
% %     end
%     fclose(fid); 
% save([PathName,'\\',FileName,'V1000_mag_yaw.dat'],'data_ck','-ascii','-append' )
...
%     end
    fclose(fid); 
save([PathName,'\\',FileName,'V1000_sl_att_txt.dat'],'data_ck','-ascii','-double','-append' )
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% data_10 = [];
% for i=1:length(data_sl_DataFusion_txt)
%         data_10(:,i)=eval(data_sl_DataFusion_txt{i,1});        
% end
%         head=[data_sl_DataFusion_txt{1}];
%         for i=2:length(data_sl_DataFusion_txt)
%          head=[head ,' ',data_sl_DataFusion_txt{i}];
%         end 
%         head=[head ,'\n'];
% data_ck=data_10(:,1:i);
% fid=fopen([PathName,'\\',FileName,'V1000_sl_DataFusion_txt.dat'],'w');
% fprintf(fid,head);
% %     [count,num]=size(data_ck);
% %     for i=1:count
% %         for j=1:num
...
% %     end
%     fclose(fid); 
% save([PathName,'\\',FileName,'V1000_sl_DataFusion_txt.dat'],'data_ck','-ascii','-append' )
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% data_11 = [];
% for i=1:length(data_imu_tmp_txt)
%         data_11(:,i)=eval(data_imu_tmp_txt{i,1});        
% end
%         head=[data_imu_tmp_txt{1}];
%         for i=2:length(data_imu_tmp_txt)
%          head=[head ,' ',data_imu_tmp_txt{i}];
%         end 
%         head=[head ,'\n'];
% data_ck=data_11(:,1:i);
% fid=fopen([PathName,'\\',FileName,'V1000_imu_tmp_txt.dat'],'w');
% fprintf(fid,head);
% %     [count,num]=size(data_ck);
% %     for i=1:count
% %         for j=1:num
...
% %     end
%     fclose(fid); 
% save([PathName,'\\',FileName,'V1000_imu_tmp_txt.dat'],'data_ck','-ascii','-append' )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data_12 = [];
for i=1:length(data_position_txt)
        data_12(:,i)=eval(data_position_txt{i,1});        
end
        head=[data_position_txt{1}];
        for i=2:length(data_position_txt)
         head=[head ,' ',data_position_txt{i}];
        end 
        head=[head ,'\n'];
data_ck=data_12(:,1:i);
fid=fopen([PathName,'\\',FileName,'V1000_position_txt.dat'],'w');
fprintf(fid,head);
%     [count,num]=size(data_ck);
%     for i=1:count
%         for j=1:num
...
%     end
    fclose(fid); 
save([PathName,'\\',FileName,'V1000_position_txt.dat'],'data_ck','-ascii','-append' )


% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% data_13 = [];
% for i=1:length(data_sl_temp)
%         data_13(:,i)=eval(data_sl_temp{i,1});        
% end
%         head=[data_sl_temp{1}];
%         for i=2:length(data_sl_temp)
%          head=[head ,' ',data_sl_temp{i}];
%         end 
%         head=[head ,'\n'];
% data_ck=data_13(:,1:i);
% fid=fopen([PathName,'\\',FileName,'V1000_sl_temp.dat'],'w');
% fprintf(fid,head);
% %     [count,num]=size(data_ck);
% %     for i=1:count
% %         for j=1:num
...
% %     end
%     fclose(fid); 
% save([PathName,'\\',FileName,'V1000_sl_temp.dat'],'data_ck','-ascii','-append' )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data_14 = [];
for i=1:length(data_sl_taskmode)
        data_14(:,i)=eval(data_sl_taskmode{i,1});        
end
        head=[data_sl_taskmode{1}];
        for i=2:length(data_sl_taskmode)
         head=[head ,' ',data_sl_taskmode{i}];
        end 
        head=[head ,'\n'];
data_ck=data_14(:,1:i);
fid=fopen([PathName,'\\',FileName,'V1000_sl_taskmode.dat'],'w');
fprintf(fid,head);
%     [count,num]=size(data_ck);
%     for i=1:count
%         for j=1:num
...
%     end
    fclose(fid); 
save([PathName,'\\',FileName,'V1000_sl_taskmode.dat'],'data_ck','-ascii','-append' )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data_15 = [];
for i=1:length(data_sl_task_flight)
        data_15(:,i)=eval(data_sl_task_flight{i,1});        
end
        head=[data_sl_task_flight{1}];
        for i=2:length(data_sl_task_flight)
         head=[head ,' ',data_sl_task_flight{i}];
        end 
        head=[head ,'\n'];
data_ck=data_15(:,1:i);
fid=fopen([PathName,'\\',FileName,'V1000_sl_task_flight.dat'],'w');
fprintf(fid,head);
%     [count,num]=size(data_ck);
%     for i=1:count
%         for j=1:num
...
%     end
    fclose(fid); 
save([PathName,'\\',FileName,'V1000_sl_task_flight.dat'],'data_ck','-ascii','-append' )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data_16 = [];
for i=1:length(data_um482)
        data_16(:,i)=eval(data_um482{i,1});        
end
        head=[data_um482{1}];
        for i=2:length(data_um482)
         head=[head ,' ',data_um482{i}];
        end 
        head=[head ,'\n'];
data_ck=data_16(:,1:i);
fid=fopen([PathName,'\\',FileName,'V1000_um482.dat'],'w');
fprintf(fid,head);
%     [count,num]=size(data_ck);
%     for i=1:count
%         for j=1:num
