/*
 * Copter_Plane_h2g_4_and_1_sbs.c
 *
 * Automatically generated s-function with I/O interface for:
 * Component: Copter_Plane_h2g_4_and_1
 * Component Simulink Path: Copter_Plane_h2g_4_and_1
 * Simulation Mode: SIL
 *
 */

#define S_FUNCTION_NAME                Copter_Plane_h2g_4_and_1_sbs
...
static boolean_T processParams(SimStruct * S)
{
  if (ssGetPWork(S) != NULL) {
    int * pIsXILApplicationStarted = (int *) ssGetPWorkValue(S, 5);
    if ((pIsXILApplicationStarted!=NULL) && (*pIsXILApplicationStarted==1)) {
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
    ...
    silDebuggingDataPtr->inTheLoopType = 0;
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("Copter_Plane_h2g_4_and_1");
      mxArray *rhs[3];
      const char * simulinkBlockPath = ssGetPath(S);
      rhs[ 0 ] = mxCreateString(
        "@coder.connectivity.SimulinkInterface.getSILPILInterface");
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  /* using block based sample times */
...
static void mdlSetupRuntimeResources(SimStruct *S)
{
...

  {
    ...
    if (error != NULL) {
      ...
      ssSetErrorStatus( S,
                       "Failed to determine the installed In-the-Loop version for comparison against the In-the-Loop s-function version (release 9.8 (R2020a)_13). To avoid this error, remove the In-the-Loop s-function from your MATLAB path (e.g. delete it or move to a clean working directory).");
      return;
    }                                  /* if */
    ...
    if (strcmp(installVersion, "9.8 (R2020a)_13") != 0) {
      ssSetErrorStatus( S,
                       "The In-the-Loop s-function is incompatible with the installed In-the-Loop version (see ver('matlab')); it was generated for release 9.8 (R2020a)_13. To avoid this error, remove the In-the-Loop s-function from your MATLAB path (e.g. delete it or move to a clean working directory)");
      return;
    }                                  /* if */
