function   set_alt_target_from_climb_rate_ffg( alt_cm, climb_rate_cms,   dt,   force_descend)
...
global limit_pos_up
    ...
    % jerk_z is calculated to reach full acceleration in 1000ms.
      ...
      climb_rate_cms=climb_rate_cms*sign(alt_change);
