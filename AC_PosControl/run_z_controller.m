...
%  
    ...
    if (pid_accel_z_reset_filter) 
        ...
        pid_accel_z_input = accel_target(3);
    ...
    % update filter and calculate derivative
      ...
      input_filt_change = alpha * (accel_target(3) - pid_accel_z_input);
...
%     end
    ...
    if ((~throttle_lower && ~throttle_upper) || (i > 0 && accel_target(3) < 0) || (i < 0 && accel_target(3) > 0))      
